  ...
  return (
    <>
      <section className=" pt-20 md:px-20 bg-blue lg:pb-5 lg:pt-[120px] mt-16 border-box">
        <div className="md:container md:mx-auto px-6 bg-yellow rounded-t-[30px] mx-6">
          <div className=" flex flex-wrap">
            <div className="w-full ">
              <div className="mx-auto mb-12  text-center lg:mb-20 md:px-1 my-24">
                <h1 className="mb-3 lg:text-h1 md:text-h2 text-h3 font-bold leading-[1.2] text-blue  2xl:mx-64">
                Connect and Succeed with Funder Assists
                </h1>
                ...
                <div className="flex justify-center mt-16">
                  <img
                    src="https://hrms.difm.llc/web/index.php/admin/theme/image/loginBanner?1672204482497"
                    alt="COMPANY LOGO"
                  />
                </div>
              </div>
