...
export default function Hero() {
  ...
  return (
    ...
    >
        ...
        <div class="xl:container relative flex px-6 xl:mt-36 md:mt-20 mt-16   xl:mx-auto  ">
          <div class="relative z-20 flex flex-col ">
            <h1 class="flex flex-col xl:text-h md:text-h1 text-h3  font-semibold leading-tight   text-white">
              Empowering Agents <br className="2xl:block hidden" /> with
              Simplified Data
            </h1>
      ...
      <div className="grid xl:grid-cols-2 grid-cols-1 container lg:mx-auto pl-6 h-min  box-border">
        ...
        <div className="flex xl:flex-row flex-col  xl:items-center xl:justify-start justify-start">
          <div className="md:px-2 text-yellow">
            ...
            <br />
            <span className="text-h4 text-white mb-4">
              Where Funding Meets Efficiency
            </span>
          </div>
                ...
                <div className=" lg:mt-0 2xl:col-span-7 xl:col-span-6 lg:col-span-5 col-span-12">
                  <div className="flex md:flex-row flex-col items- justify-between">
                    <div className=" w-full text-blue md:py-0 py-4">
                      ...
                      <p className="  text-justify text-pretty text-p font-medium md:w-[85%]">
                    ...
                    <div className="">
                      <div className="pb-4 border-b-blue border-b mb-3">
                        ...
                        <div
                          ...
                          ref={contentRef}
                        >
                          <p className="font-medium text-p text-justify text-pretty w-[85%] text-blue ">
                      ...
                      <div className="pb-4 border-b-blue border-b">
                        ...
                        <div
                          ...
                          ref={contentRef}
                        >
                          <p className="font-medium text-p text-left text-blue text-justify text-pretty w-[85%]">
                            As your funding operations grow, so does your data.
                            Funder Assist scales with you, ensuring that your
                            expanding data is always manageable and accessible
                          </p>
                          <br />
                        </div>
                      </div>

                      <div className="pb-2 pt-2 md:border-b-blue md:border-b">
                        <div
                          className={`grid grid-flow-col cursor-pointer ${
                        ...
                        >
                          <p className="font-medium text-p text-left text-blue text-justify text-pretty w-[85%]">
                            Repeat success with every customer. Funder Assist's
                            repeatable processes mean you can provide reliable
                            and consistent funding services, backed by solid
                            data every time
                          </p>
                          <br />
                        </div>
